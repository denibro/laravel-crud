...
@section('content')
<!-- start banner Area -->
<section class="banner-area relative" id="home" style="background:url('{{config('sekolah.banner')  }}')">
    <div class=""></div>
    <div class="container">
        <div class="row fullscreen d-flex align-items-center justify-content-between">
            <div class="banner-content col-lg-9 col-md-12">
                ...
                <p class="pt-10 pb-10">
                    {{ config('sekolah.pesan_selamat_datang') }}
                </p>
        ...
        <div class="row d-flex justify-content-center">
            <div class="menu-content pb-70 col-lg-8">
                <div class="title text-center">
                    ...
                    <p>Informasi terkini dan terudpate</p>
                </div>
            </div>
        </div>
        <div class="row">
